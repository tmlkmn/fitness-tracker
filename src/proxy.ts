...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|favicon-.*\\.png|sw.js|sw.js.map|sw-push.js|manifest.webmanifest|icon\\.svg|icon-192.png|icon-512.png|apple-touch-icon.png|serwist-worker-.*).*)",
  ],
};
