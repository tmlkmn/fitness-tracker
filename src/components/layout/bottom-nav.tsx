...
export function BottomNav() {
  ...
  return (
    <nav data-tour="bottom-nav" aria-label={t("primaryNavigation")} className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur border-t border-border pb-[env(safe-area-inset-bottom)]">
